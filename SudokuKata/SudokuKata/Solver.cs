...
internal class Solver
{
    ...
    private bool LookIfTheBoardHasMultipleSolutions()
    {
        ...
        while (candidates.Any())
        {
            ...
            string command = SolverMainLoop(alternateState, combinedStack, lastDigitStack);
    ...
    private string SolverMainLoop(int[] alternateState, Stack<(int[] state, int rowIndex, int colIndex, bool[] usedDigits)> combinedStack, Stack<int> lastDigitStack)
    {
